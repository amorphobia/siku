...
|[ddns-go](https://github.com/jeessy2/ddns-go)<sup> [m](https://github.com/amorphobia/siku/blob/master/bucket/ddns-go.json)</sup>|简单好用的DDNS。自动更新域名解析到公网IP(支持阿里云、腾讯云dnspod、Cloudflare、Callback、华为云、百度云、Porkbun、GoDaddy、Google Domains)|
...
|[gitea-runner](https://docs.gitea.com/usage/actions/act-runner)<sup> [m](https://github.com/amorphobia/siku/blob/master/bucket/gitea-runner.json)</sup>|A runner for Gitea based on act|
...
|[mihomo-v1](https://github.com/MetaCubeX/mihomo)<sup> [m](https://github.com/amorphobia/siku/blob/master/bucket/mihomo-v1.json)</sup>|A simple Python Pydantic model for Honkai: Star Rail parsed data from the Mihomo API.|
...
|[mihomo-v3](https://github.com/MetaCubeX/mihomo)<sup> [m](https://github.com/amorphobia/siku/blob/master/bucket/mihomo-v3.json)</sup>|A simple Python Pydantic model for Honkai: Star Rail parsed data from the Mihomo API.|
...
|[pcl-ce](https://www.pclc.cc/projects/pcl-ce/)<sup> [m](https://github.com/amorphobia/siku/blob/master/bucket/pcl-ce.json)</sup>|由社区强力驱动的 PCL 二次开发版|
...
|[vuetorrent](https://github.com/VueTorrent/VueTorrent)<sup> [m](https://github.com/amorphobia/siku/blob/master/bucket/vuetorrent.json)</sup>|The sleekest looking WEBUI for qBittorrent made with Vuejs!|
