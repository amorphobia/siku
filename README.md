...
|[busybox-standalone](https://frippery.org/busybox)<sup>[manifest](https://github.com/amorphobia/siku/blob/master/bucket/busybox-standalone.json)</sup>|BusyBox is a single binary that contains many common Unix tools (standalone version)|
